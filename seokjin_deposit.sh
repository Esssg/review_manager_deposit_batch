...
echo "석진 계좌 입금 내역 확인 중..."
# 석진 계좌 확인	
uv run python ./bankapi_to_supabase.py --apikey "$API_KEY" --secretkey "$SECRET_KEY" --accountNumber "1002950943065" --startDate "$START_DATE" --endDate "$END_DATE" --ignoreSslError
